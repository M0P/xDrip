...
public class T4ReplyTest extends HexTestTools {
    ...
    public void parseTest1() {
        ...
        final byte[] b1 = tolerantHexStringToByteArray("0090");
        ...
        final byte[] b2 = tolerantHexStringToByteArray("12340090");
        ...
        final byte[] b3 = tolerantHexStringToByteArray("45679000");
    ...
    public void parseTest2() {
        final byte[] b1 = tolerantHexStringToByteArray("012345679000");
        final byte[] b2 = tolerantHexStringToByteArray("890123459000");

        final T4Reply r = T4Reply.parse(b1);
        ...
        final T4Reply r2 = T4Reply.parse(b2, r);
