...
public class NotificationChannelsTest extends RobolectricTestWithConfig {
    ...
    public void getNotificationFromInsideBuilderTest() {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(RuntimeEnvironment.getApplication().getApplicationContext(), (String)null);
        builder.setVibrate(pattern);
        Notification mNotification = NotificationChannels.getNotificationFromInsideBuilder(builder);
